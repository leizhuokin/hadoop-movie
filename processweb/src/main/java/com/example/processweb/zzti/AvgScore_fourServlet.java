...
@WebServlet(name = "AvgScore_fourServlet", urlPatterns = "/AvgScore_fourServlet")
public class AvgScore_fourServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //1.读取HDFS上的数据分析结果
        String path = "hdfs://192.168.100.101:9000/zzti/result/AvgScore_four";
        List<Map> rows = null;
        try {
